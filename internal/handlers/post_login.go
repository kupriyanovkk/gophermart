...
func Login(w http.ResponseWriter, r *http.Request, s store.Store) {
	...
	userID, err := s.LoginUser(r.Context(), strings.TrimSpace(req.Login), strings.TrimSpace(req.Password))
